...
import { 
  ...
  Check, FileText, Users, Shield, Cloud, Car, Package, Building, Heart, Camera, X
} from 'lucide-react';
...
// const SuccessModal: React.FC<SuccessModalProps> = ({ isOpen, onClose, onStartNew, countdown }) => {
...
//           <p className="text-green-100 mt-2">Your incident report has been received.</p>
//         </div>

//         {/* Content */}
//         <div className="px-6 py-6">
//           <p className="text-gray-600 text-center mb-6">
//             Our claims team will review your submission and be in touch soon.
//           </p>
...
//               <a 
//                 href="tel:5155817187" 
//                 className="flex items-center justify-center gap-3 bg-white border border-gray-200 rounded-lg px-4 py-3 hover:border-orange-300 hover:bg-orange-50 transition-all group"
//               >
...
//                   </svg>
//                 </div>
//                 <span className="text-gray-700 font-semibold">(515) 581-7187</span>
//               </a>
...
//                   </svg>
//                 </div>
//                 <span className="text-gray-700 font-semibold">claims@moxieriskpartners.com</span>
//               </a>
//             </div>
//           </div>
...
//                 Form will reset in <span className="font-semibold text-orange-600">{countdown}</span> seconds
//               </p>
//               <p className="text-xs text-gray-400 mt-1">Click anywhere to cancel auto-reset</p>
//             </div>
//           )}
//         </div>
...
//             type="button"
//             onClick={onStartNew}
//             className="w-full py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl font-bold hover:from-orange-600 hover:to-red-600 transition-all shadow-lg hover:shadow-xl"
//           >
//             Start New Claim
//           </button>
//           <button
...
//         witnesses: witnesses.filter((w) => w.name),
//         files: uploadedFiles,
//         policeReportFiles: policeReportFiles,
//       };
...
//                   onChange={handleInputChange}
//                   label="TRUCK OWNER name and contact (if not owned by your company)"
//                 />
//                 <VehicleFields
//                   prefix="truck"
//                   values={{
...
//                 onChange={handleInputChange}
//                 label="TRAILER OWNER name and contact (if not owned by your company)"
//               />
...
//                   onChange={handleInputChange}
//                   label="VEHICLE OWNER name and contact"
//                 />
...
//                   onChange={handleInputChange}
//                   label="PROPERTY OWNER name and contact"
//                 />
//                 <TextArea
//                   label="DESCRIPTION OF DAMAGED PROPERTY"
//                   name="propertyDescription"
